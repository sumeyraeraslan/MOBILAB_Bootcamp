...
import 'package:drips/views/navBar.dart';
          ...
          children: [
            ...
            SizedBox(
              child: GridView.count(
                ...
                children: const [
                  Urunlerbox(imagePath: 'image/shoes/1.png', size: 140),
                  Urunlerbox(imagePath: 'image/shoes/2.png', size: 140),
                  Urunlerbox(imagePath: 'image/shoes/3.jpg', size: 140),
                  Urunlerbox(imagePath: 'image/shoes/4.png', size: 140),
                  Urunlerbox(imagePath: 'image/shoes/5.png', size: 140),
                  Urunlerbox(imagePath: 'image/shoes/6.png', size: 140),
                ],
              ),
            ),
          ],
